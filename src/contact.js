document.addEventListener("DOMContentLoaded", () => {
  ...
  if (!contactRoot) {
    console.error("contact root element not found");
    return;
  }

  contactRoot.classList.add(
    "font-outfit",
    "text-green-800",
    "pt-28",
    "md:pt-40",
  ...
  contactRoot.appendChild(header);
  ...
  contactRoot.appendChild(bigDiv);
});
